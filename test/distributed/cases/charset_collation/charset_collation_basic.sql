...
SELECT COERCIBILITY(123);
SELECT COERCIBILITY(0123);
SELECT COERCIBILITY('0123');
SELECT COERCIBILITY(45.67);
SELECT COERCIBILITY(CAST(100 AS INT));

-- Test coercibility values 0-3
SELECT COERCIBILITY('abc' COLLATE utf8mb4_bin) AS explicit_collate;
SELECT COERCIBILITY(USER()) AS system_constant;
SELECT COERCIBILITY(VERSION()) AS system_version;
SELECT COERCIBILITY(CAST('test' AS VARBINARY(100))) AS no_collation;
