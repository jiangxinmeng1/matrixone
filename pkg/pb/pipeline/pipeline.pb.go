...
func (SampleFunc_SampleType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{46, 0}
}
...
func (Pipeline_PipelineType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7ac67a7adf3df9c7, []int{56, 0}
}
...
type LockTarget struct {
	...
	PartitionColIdxInBat int32           `protobuf:"varint,12,opt,name=partition_col_idx_in_bat,json=partitionColIdxInBat,proto3" json:"partition_col_idx_in_bat,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
type SemiJoin struct {
	...
	CanSkipProbe           bool                      `protobuf:"varint,7,opt,name=can_skip_probe,json=canSkipProbe,proto3" json:"can_skip_probe,omitempty"`
	IsShuffle              bool                      `protobuf:"varint,8,opt,name=is_shuffle,json=isShuffle,proto3" json:"is_shuffle,omitempty"`
	JoinMapTag             int32                     `protobuf:"varint,9,opt,name=join_map_tag,json=joinMapTag,proto3" json:"join_map_tag,omitempty"`
	ShuffleIdx             int32                     `protobuf:"varint,10,opt,name=shuffle_idx,json=shuffleIdx,proto3" json:"shuffle_idx,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                  `json:"-"`
...
func (m *SemiJoin) GetCanSkipProbe() bool {
	if m != nil {
		return m.CanSkipProbe
	}
	return false
}
...
type DedupJoin struct {
	...
	OnDuplicateAction      plan.Node_OnDuplicateAction `protobuf:"varint,9,opt,name=on_duplicate_action,json=onDuplicateAction,proto3,enum=plan.Node_OnDuplicateAction" json:"on_duplicate_action,omitempty"`
	...
	TargetTableId          uint64                      `protobuf:"varint,17,opt,name=target_table_id,json=targetTableId,proto3" json:"target_table_id,omitempty"`
	InitialSnapshotTs      timestamp.Timestamp         `protobuf:"bytes,18,opt,name=initial_snapshot_ts,json=initialSnapshotTs,proto3" json:"initial_snapshot_ts"`
	TargetTableRef         *plan.ObjectRef             `protobuf:"bytes,19,opt,name=target_table_ref,json=targetTableRef,proto3" json:"target_table_ref,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                    `json:"-"`
	XXX_unrecognized       []byte                      `json:"-"`
	XXX_sizecache          int32                       `json:"-"`
}
...
func (m *DedupJoin) String() string { return proto.CompactTextString(m) }
...
func (m *DedupJoin) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DedupJoin.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DedupJoin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DedupJoin.Merge(m, src)
}
func (m *DedupJoin) XXX_Size() int {
	return m.ProtoSize()
}
func (m *DedupJoin) XXX_DiscardUnknown() {
	xxx_messageInfo_DedupJoin.DiscardUnknown(m)
}

var xxx_messageInfo_DedupJoin proto.InternalMessageInfo
...
func (m *DedupJoin) GetOnDuplicateAction() plan.Node_OnDuplicateAction {
	if m != nil {
		return m.OnDuplicateAction
	}
	return plan.Node_FAIL
}

func (m *DedupJoin) GetDedupColName() string {
	if m != nil {
		return m.DedupColName
	}
	return ""
}
...
func (m *DedupJoin) GetTargetTableId() uint64 {
	if m != nil {
		return m.TargetTableId
	}
	return 0
}

func (m *DedupJoin) GetInitialSnapshotTs() timestamp.Timestamp {
	if m != nil {
		return m.InitialSnapshotTs
	}
	return timestamp.Timestamp{}
}

func (m *DedupJoin) GetTargetTableRef() *plan.ObjectRef {
	if m != nil {
		return m.TargetTableRef
	}
	return nil
}
...
func (m *RightDedupJoin) Reset()         { *m = RightDedupJoin{} }
func (m *RightDedupJoin) String() string { return proto.CompactTextString(m) }
...
func (m *RightDedupJoin) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RightDedupJoin.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RightDedupJoin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RightDedupJoin.Merge(m, src)
}
func (m *RightDedupJoin) XXX_Size() int {
	return m.ProtoSize()
}
func (m *RightDedupJoin) XXX_DiscardUnknown() {
	xxx_messageInfo_RightDedupJoin.DiscardUnknown(m)
}

var xxx_messageInfo_RightDedupJoin proto.InternalMessageInfo
...
type HashBuild struct {
	...
	RuntimeFilterSpec    *plan.RuntimeFilterSpec     `protobuf:"bytes,8,opt,name=RuntimeFilterSpec,proto3" json:"RuntimeFilterSpec,omitempty"`
	IsDedup              bool                        `protobuf:"varint,9,opt,name=is_dedup,json=isDedup,proto3" json:"is_dedup,omitempty"`
	OnDuplicateAction    plan.Node_OnDuplicateAction `protobuf:"varint,10,opt,name=on_duplicate_action,json=onDuplicateAction,proto3,enum=plan.Node_OnDuplicateAction" json:"on_duplicate_action,omitempty"`
	DedupColName         string                      `protobuf:"bytes,11,opt,name=dedup_col_name,json=dedupColName,proto3" json:"dedup_col_name,omitempty"`
	DedupColTypes        []plan.Type                 `protobuf:"bytes,12,rep,name=dedup_col_types,json=dedupColTypes,proto3" json:"dedup_col_types"`
	DelColIdx            int32                       `protobuf:"varint,13,opt,name=del_col_idx,json=delColIdx,proto3" json:"del_col_idx,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
type Shufflebuild struct {
	...
	IsDedup              bool                        `protobuf:"varint,8,opt,name=is_dedup,json=isDedup,proto3" json:"is_dedup,omitempty"`
	OnDuplicateAction    plan.Node_OnDuplicateAction `protobuf:"varint,9,opt,name=on_duplicate_action,json=onDuplicateAction,proto3,enum=plan.Node_OnDuplicateAction" json:"on_duplicate_action,omitempty"`
	DedupColName         string                      `protobuf:"bytes,10,opt,name=dedup_col_name,json=dedupColName,proto3" json:"dedup_col_name,omitempty"`
	DedupColTypes        []plan.Type                 `protobuf:"bytes,11,rep,name=dedup_col_types,json=dedupColTypes,proto3" json:"dedup_col_types"`
	DelColIdx            int32                       `protobuf:"varint,12,opt,name=del_col_idx,json=delColIdx,proto3" json:"del_col_idx,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *Shufflebuild) GetOnDuplicateAction() plan.Node_OnDuplicateAction {
	if m != nil {
		return m.OnDuplicateAction
	}
	return plan.Node_FAIL
...
func (m *Shufflebuild) GetDedupColName() string {
	if m != nil {
		return m.DedupColName
	}
	return ""
...
func (m *Shufflebuild) GetDedupColTypes() []plan.Type {
	if m != nil {
		return m.DedupColTypes
	}
	return nil
...
func (m *Shufflebuild) GetDelColIdx() int32 {
	if m != nil {
		return m.DelColIdx
	}
	return 0
...
type Instruction struct {
	...
	Join            *Join               `protobuf:"bytes,7,opt,name=join,proto3" json:"join,omitempty"`
	...
	DedupJoin       *DedupJoin          `protobuf:"bytes,12,opt,name=dedup_join,json=dedupJoin,proto3" json:"dedup_join,omitempty"`
	...
	OnDuplicateKey  *OnDuplicateKey     `protobuf:"bytes,17,opt,name=on_duplicate_key,json=onDuplicateKey,proto3" json:"on_duplicate_key,omitempty"`
	...
	RightDedupJoin          *RightDedupJoin          `protobuf:"bytes,31,opt,name=right_dedup_join,json=rightDedupJoin,proto3" json:"right_dedup_join,omitempty"`
	...
	ShuffleBuild            *Shufflebuild            `protobuf:"bytes,50,opt,name=shuffle_build,json=shuffleBuild,proto3" json:"shuffle_build,omitempty"`
	IndexBuild              *Indexbuild              `protobuf:"bytes,51,opt,name=index_build,json=indexBuild,proto3" json:"index_build,omitempty"`
	Apply                   *Apply                   `protobuf:"bytes,52,opt,name=apply,proto3" json:"apply,omitempty"`
	MultiUpdate             *MultiUpdate             `protobuf:"bytes,53,opt,name=multi_update,json=multiUpdate,proto3" json:"multi_update,omitempty"`
	PostDml                 *PostDml                 `protobuf:"bytes,54,opt,name=post_dml,json=postDml,proto3" json:"post_dml,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                 `json:"-"`
	XXX_unrecognized        []byte                   `json:"-"`
	XXX_sizecache           int32                    `json:"-"`
}
...
type Source struct {
	...
	BlockOrderBy           []*plan.OrderBySpec       `protobuf:"bytes,14,rep,name=block_order_by,json=blockOrderBy,proto3" json:"block_order_by,omitempty"`
	BlockLimit             uint64                    `protobuf:"varint,15,opt,name=block_limit,json=blockLimit,proto3" json:"block_limit,omitempty"`
	BloomFilter            []byte                    `protobuf:"bytes,16,opt,name=bloom_filter,json=bloomFilter,proto3" json:"bloom_filter,omitempty"`
	XXX_NoUnkeyedLiteral   struct{}                  `json:"-"`
	XXX_unrecognized       []byte                    `json:"-"`
	XXX_sizecache          int32                     `json:"-"`
}
...
func (m *Source) GetBlockOrderBy() []*plan.OrderBySpec {
	if m != nil {
		return m.BlockOrderBy
	}
	return nil
}

func (m *Source) GetBlockLimit() uint64 {
	if m != nil {
		return m.BlockLimit
	}
	return 0
...
func (m *Source) GetBloomFilter() []byte {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*DedupJoin)(nil), "pipeline.DedupJoin")
	proto.RegisterType((*RightDedupJoin)(nil), "pipeline.RightDedupJoin")
...
var fileDescriptor_7ac67a7adf3df9c7 = []byte{
	// 6177 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DebugMsg) > 0 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.DebugMsg)))
		i--
		dAtA[i] = 0x52
	}
	if m.NeedNotReply {
...
func (m *Shuffle) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ShuffleExpr != nil {
		{
			size, err := m.ShuffleExpr.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.ShuffleRangesInt64) > 0 {
		dAtA4 := make([]byte, len(m.ShuffleRangesInt64)*10)
		var j3 int
	...
	if len(m.ShuffleRangesUint64) > 0 {
		dAtA6 := make([]byte, len(m.ShuffleRangesUint64)*10)
		var j5 int
...
func (m *Dispatch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ShuffleRegIdxRemote) > 0 {
		dAtA8 := make([]byte, len(m.ShuffleRegIdxRemote)*10)
		var j7 int
	...
	if len(m.ShuffleRegIdxLocal) > 0 {
		dAtA10 := make([]byte, len(m.ShuffleRegIdxLocal)*10)
		var j9 int
...
func (m *MultiUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UpdateCtxList) > 0 {
		for iNdEx := len(m.UpdateCtxList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UpdateCtxList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.Action != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.Action))
		i--
		dAtA[i] = 0x10
	}
	if m.AffectedRows != 0 {
...
func (m *PreInsert) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColOffset != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ColOffset))
		i--
		dAtA[i] = 0x30
	}
	if m.HasAutoCol {
...
func (m *LockTarget) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PartitionColIdxInBat != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.PartitionColIdxInBat))
		i--
		dAtA[i] = 0x60
	}
	if m.ObjRef != nil {
	...
	if m.LockRows != nil {
		{
			size, err := m.LockRows.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *OnDuplicateKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OnDuplicateIdx) > 0 {
		dAtA36 := make([]byte, len(m.OnDuplicateIdx)*10)
		var j35 int
...
func (m *DedupJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TargetTableRef != nil {
		{
			size, err := m.TargetTableRef.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	{
		size, err := m.InitialSnapshotTs.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x92
	if m.TargetTableId != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.TargetTableId))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
	...
	if len(m.UpdateColExprList) > 0 {
		for iNdEx := len(m.UpdateColExprList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UpdateColExprList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.UpdateColIdxList) > 0 {
		dAtA76 := make([]byte, len(m.UpdateColIdxList)*10)
		var j75 int
	...
	if len(m.DedupColTypes) > 0 {
		for iNdEx := len(m.DedupColTypes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DedupColTypes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.DedupColName) > 0 {
		i -= len(m.DedupColName)
		copy(dAtA[i:], m.DedupColName)
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.DedupColName)))
		i--
		dAtA[i] = 0x52
	}
	if m.OnDuplicateAction != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.OnDuplicateAction))
		i--
		dAtA[i] = 0x48
	}
	if m.ShuffleIdx != 0 {
...
func (m *RightDedupJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UpdateColIdxList) > 0 {
		dAtA82 := make([]byte, len(m.UpdateColIdxList)*10)
		var j81 int
		for _, num1 := range m.UpdateColIdxList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *Product) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA88 := make([]byte, len(m.ColList)*10)
		var j87 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA90 := make([]byte, len(m.RelList)*10)
		var j89 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *ProductL2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.VectorOpType) > 0 {
		i -= len(m.VectorOpType)
		copy(dAtA[i:], m.VectorOpType)
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.VectorOpType)))
		i--
		dAtA[i] = 0x2a
	}
	if m.JoinMapTag != 0 {
	...
	if len(m.ColList) > 0 {
		dAtA93 := make([]byte, len(m.ColList)*10)
		var j92 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA95 := make([]byte, len(m.RelList)*10)
		var j94 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j94))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *IndexJoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Result) > 0 {
		dAtA97 := make([]byte, len(m.Result)*10)
		var j96 int
		for _, num1 := range m.Result {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j96))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *FileOffset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Offset) > 0 {
		dAtA99 := make([]byte, len(m.Offset)*10)
		var j98 int
...
func (m *ExternalScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ColumnListLen != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.ColumnListLen))
		i--
		dAtA[i] = 0x50
	}
	if m.StrictSqlMode {
...
func (m *Instruction) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MultiUpdate != nil {
		{
			size, err := m.MultiUpdate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.RightDedupJoin != nil {
		{
			size, err := m.RightDedupJoin.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.DedupJoin != nil {
		{
			size, err := m.DedupJoin.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Source) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BloomFilter) > 0 {
		...
		i = encodeVarintPipeline(dAtA, i, uint64(len(m.BloomFilter)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
	...
	if m.BlockLimit != 0 {
		i = encodeVarintPipeline(dAtA, i, uint64(m.BlockLimit))
		i--
		dAtA[i] = 0x78
	}
	if len(m.BlockOrderBy) > 0 {
		for iNdEx := len(m.BlockOrderBy) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BlockOrderBy[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Pipeline) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NilBatchCnt) > 0 {
		dAtA159 := make([]byte, len(m.NilBatchCnt)*10)
		var j158 int
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j158))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.ChannelBufferSize) > 0 {
		dAtA161 := make([]byte, len(m.ChannelBufferSize)*10)
		var j160 int
		...
		i = encodeVarintPipeline(dAtA, i, uint64(j160))
		i--
		dAtA[i] = 0x62
	}
...
func (m *Apply) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ColList) > 0 {
		dAtA166 := make([]byte, len(m.ColList)*10)
		var j165 int
		for _, num1 := range m.ColList {
			num := uint64(num1)
			for num >= 1<<7 {
	...
	if len(m.RelList) > 0 {
		dAtA168 := make([]byte, len(m.RelList)*10)
		var j167 int
		for _, num1 := range m.RelList {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *MultiUpdate) ProtoSize() (n int) {
	...
	if m.Action != 0 {
		n += 1 + sovPipeline(uint64(m.Action))
	}
	if len(m.UpdateCtxList) > 0 {
...
func (m *PreInsert) ProtoSize() (n int) {
	...
	if m.ColOffset != 0 {
		n += 1 + sovPipeline(uint64(m.ColOffset))
	}
	if m.EstimatedRowCount != 0 {
...
func (m *LockTarget) ProtoSize() (n int) {
	...
	if m.PartitionColIdxInBat != 0 {
		n += 1 + sovPipeline(uint64(m.PartitionColIdxInBat))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *DedupJoin) ProtoSize() (n int) {
	...
	if m.OnDuplicateAction != 0 {
		n += 1 + sovPipeline(uint64(m.OnDuplicateAction))
	}
	l = len(m.DedupColName)
	if l > 0 {
		n += 1 + l + sovPipeline(uint64(l))
	}
	if len(m.DedupColTypes) > 0 {
		for _, e := range m.DedupColTypes {
			l = e.ProtoSize()
			n += 1 + l + sovPipeline(uint64(l))
		}
	}
	...
	if len(m.UpdateColIdxList) > 0 {
		l = 0
		for _, e := range m.UpdateColIdxList {
			l += sovPipeline(uint64(e))
		}
		n += 1 + sovPipeline(uint64(l)) + l
	}
	if len(m.UpdateColExprList) > 0 {
		for _, e := range m.UpdateColExprList {
			l = e.ProtoSize()
			n += 1 + l + sovPipeline(uint64(l))
		}
	}
	...
	if m.TargetTableId != 0 {
		n += 2 + sovPipeline(uint64(m.TargetTableId))
	}
	l = m.InitialSnapshotTs.ProtoSize()
	n += 2 + l + sovPipeline(uint64(l))
	if m.TargetTableRef != nil {
		l = m.TargetTableRef.ProtoSize()
		n += 2 + l + sovPipeline(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *ExternalScan) ProtoSize() (n int) {
	...
	if m.ColumnListLen != 0 {
		n += 1 + sovPipeline(uint64(m.ColumnListLen))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *HashBuild) ProtoSize() (n int) {
	...
	if m.DelColIdx != 0 {
		n += 1 + sovPipeline(uint64(m.DelColIdx))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Source) ProtoSize() (n int) {
	...
	if len(m.BlockOrderBy) > 0 {
		for _, e := range m.BlockOrderBy {
			l = e.ProtoSize()
			n += 1 + l + sovPipeline(uint64(l))
		}
	}
	if m.BlockLimit != 0 {
		n += 1 + sovPipeline(uint64(m.BlockLimit))
	}
	l = len(m.BloomFilter)
	if l > 0 {
		n += 2 + l + sovPipeline(uint64(l))
...
func (m *Shuffle) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShuffleExpr", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ShuffleExpr == nil {
				m.ShuffleExpr = &plan.Expr{}
			}
			if err := m.ShuffleExpr.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MultiUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.UpdateCtxList = append(m.UpdateCtxList, &plan.UpdateCtx{})
			if err := m.UpdateCtxList[len(m.UpdateCtxList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PreInsert) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColOffset", wireType)
			}
			m.ColOffset = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ColOffset |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsOldUpdate", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.IsOldUpdate = bool(v != 0)
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsNewUpdate", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *LockTarget) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockRows", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LockRows == nil {
				m.LockRows = &plan.Expr{}
			}
			if err := m.LockRows.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockTableAtTheEnd", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PartitionColIdxInBat", wireType)
			}
			m.PartitionColIdxInBat = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PartitionColIdxInBat |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SemiJoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CanSkipProbe", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *DedupJoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DedupJoin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DedupJoin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnDuplicateAction", wireType)
			}
			m.OnDuplicateAction = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPipeline
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnDuplicateAction |= plan.Node_OnDuplicateAction(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DedupColName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DedupColName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DedupColTypes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DedupColTypes = append(m.DedupColTypes, plan.Type{})
			if err := m.DedupColTypes[len(m.DedupColTypes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 12:
		...
		case 14:
			if wireType == 0 {
				...
				m.UpdateColIdxList = append(m.UpdateColIdxList, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.UpdateColIdxList) == 0 {
					m.UpdateColIdxList = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateColIdxList", wireType)
			}
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdateColExprList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UpdateColExprList = append(m.UpdateColExprList, &plan.Expr{})
			if err := m.UpdateColExprList[len(m.UpdateColExprList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 16:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelColIdx", wireType)
			}
			m.DelColIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DelColIdx |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetTableId", wireType)
			}
			m.TargetTableId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetTableId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialSnapshotTs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.InitialSnapshotTs.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 19:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TargetTableRef", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TargetTableRef == nil {
				m.TargetTableRef = &plan.ObjectRef{}
			}
			if err := m.TargetTableRef.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RightDedupJoin) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RightDedupJoin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RightDedupJoin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
...
func (m *ProductL2) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VectorOpType", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.VectorOpType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPipeline(dAtA[iNdEx:])
...
func (m *ExternalScan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Attrs = append(m.Attrs, plan.ExternAttr{})
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColumnListLen", wireType)
			}
			m.ColumnListLen = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ColumnListLen |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *HashBuild) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsDedup", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Instruction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DedupJoin", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DedupJoin == nil {
				m.DedupJoin = &DedupJoin{}
			}
			if err := m.DedupJoin.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 13:
		...
		case 22:
			...
			m.Filters = append(m.Filters, &plan.Expr{})
		...
		case 23:
			...
			m.RuntimeFilters = append(m.RuntimeFilters, &plan.Expr{})
		...
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RightDedupJoin", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RightDedupJoin == nil {
				m.RightDedupJoin = &RightDedupJoin{}
			}
			if err := m.RightDedupJoin.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 32:
		...
		case 53:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MultiUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MultiUpdate == nil {
				m.MultiUpdate = &MultiUpdate{}
			}
			if err := m.MultiUpdate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 54:
...
func (m *Source) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			m.RecvMsgList = append(m.RecvMsgList, plan.MsgHeader{})
		...
		case 14:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockOrderBy", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlockOrderBy = append(m.BlockOrderBy, &plan.OrderBySpec{})
			if err := m.BlockOrderBy[len(m.BlockOrderBy)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 15:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BlockLimit |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
