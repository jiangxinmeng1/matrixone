...
func (w *CNS3Writer) PipelineFileSinkerPendingStats() (count int64, arenaBytes int64) {
	if w == nil || w.sinker == nil {
		return 0, 0
	}
	return w.sinker.PipelineFileSinkerPending()
}
...
func (w *CNS3Writer) FileSinkerMemoryStats() objectio.WriteArenaStats {
	if w == nil || w.sinker == nil {
		return objectio.WriteArenaStats{}
	}
	return w.sinker.FileSinkerMemoryStats()
}
